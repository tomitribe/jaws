...
public class S3FileNodeUnknown3Test {
    ...
    public final void setUp() throws Exception {
        ...
        final S3Bucket bucket = s3Client.createBucket("repository")
                ...
                .put("org.color.bright/green/1/1.4/a/b/c/foo.txt", "green")
                .put("junit/junit/4/4.12/bar.txt", "blue")
                .put("io.tomitribe/crest/5/5.4.1.2/baz.txt", "orange");

        file = bucket.root().getFile("org.color.bright/green/1");
    ...
    public void delete() {
        ...
        final S3File file = bucket.root().getFile("junit/junit/4/4.12");
